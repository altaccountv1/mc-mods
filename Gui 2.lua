...
Converted["_UICorner8"].Parent = Converted["_DragonToggle"]
...
Converted["_UICorner9"].Parent = Converted["_Credits"]
...
Converted["_UICorner10"].Parent = Converted["_X"]
